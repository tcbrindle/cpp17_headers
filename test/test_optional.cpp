...
stx::optional<char> readNextChar(){ return{}; }

void run(stx::optional<std::string>) {}
...
bool fun(std::string , stx::optional<int> oi = stx::nullopt)
{
  return bool(oi);
}
...
static_assert(std::is_base_of<std::logic_error, stx::bad_optional_access>::value, "");
